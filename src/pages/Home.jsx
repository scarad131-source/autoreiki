    ...
    <div className="space-y-10">
      ...
      <section className="space-y-4">
        ...
        <nav className="grid grid-cols-2 gap-3">
          <button
            onClick={() => navigate("/configurar")}
            className="relative aspect-square w-full overflow-hidden border border-primary/30 gold-glow hover:border-primary/50 transition-colors active:scale-[0.98]"
