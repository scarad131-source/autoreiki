        ...
        <div className="grid grid-cols-2 gap-4">
          {MODES.map((m) => {
            ...
            return (
              ...
              <p className="tracking-tight font-normal [font-family:'Aether',_sans-serif] text-base" style={{ color: m.color }}>{m.name}</p>
              <p className="text-muted-foreground mt-1 leading-snug max-w-[140px] text-xs">{m.desc}</p>
            </button>);
