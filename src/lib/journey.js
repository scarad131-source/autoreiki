...
export const JOURNEY = [
  ...
  { day: 1, title: "Despertar la respiración", focus: "Toma conciencia del aire que entra y sale", config: { mode: "guided", level: "beginner", audio: "meditation21", minutes: 5 } },
  { day: 2, title: "Escuchar el silencio", focus: "Atención a los sonidos sin juzgarlos", config: { mode: "guided", level: "beginner", audio: "meditation21", minutes: 5 } },
  { day: 3, title: "Sentir el cuerpo", focus: "Recorrido suave por cada zona del cuerpo", config: { mode: "guided", level: "beginner", audio: "meditation21", minutes: 5 } },
  { day: 4, title: "Aroma de calma", focus: "Imagina fragancias que te serenan", config: { mode: "guided", level: "beginner", audio: "meditation21", minutes: 5 } },
  { day: 5, title: "Textura del presente", focus: "Toca y siente sin nombrar", config: { mode: "guided", level: "beginner", audio: "meditation21", minutes: 5 } },
  { day: 6, title: "Gusto de la quietud", focus: "Saborea el instante con lentitud", config: { mode: "guided", level: "beginner", audio: "meditation21", minutes: 5 } },
  { day: 7, title: "Sentidos integrados", focus: "Los cinco sentidos en un solo instante", config: { mode: "guided", level: "beginner", audio: "meditation21", minutes: 5 } },
  // Fase 2 — Mejorar concentración
  { day: 8, title: "Anclar la mente", focus: "Fija la atención en un solo punto", config: { mode: "guided", level: "intermediate", audio: "meditation21", minutes: 10 } },
  { day: 9, title: "Respiración 4-7-8", focus: "Ritmo que calma y concentra", config: { mode: "guided", level: "intermediate", audio: "meditation21", minutes: 10 } },
  { day: 10, title: "Foco en un punto", focus: "Mantén la atención sin desviarte", config: { mode: "guided", level: "intermediate", audio: "meditation21", minutes: 10 } },
  { day: 11, title: "Contar sin juzgar", focus: "Cuenta respiraciones del 1 al 10", config: { mode: "guided", level: "intermediate", audio: "meditation21", minutes: 10 } },
  { day: 12, title: "Observar el pensamiento", focus: "Mira los pensamientos pasar como nubes", config: { mode: "guided", level: "intermediate", audio: "meditation21", minutes: 10 } },
  { day: 13, title: "Vacío y plenitud", focus: "Reposa en el espacio entre pensamientos", config: { mode: "guided", level: "intermediate", audio: "meditation21", minutes: 10 } },
  { day: 14, title: "Concentración estable", focus: "Atención sostenida sin esfuerzo", config: { mode: "guided", level: "intermediate", audio: "meditation21", minutes: 10 } },
  // Fase 3 — Integración
  { day: 15, title: "Fluir sin esfuerzo", focus: "Deja que la práctica suceda", config: { mode: "guided", level: "intermediate", audio: "meditation21", minutes: 20 } },
  { day: 16, title: "Equilibrio de chakras", focus: "Armoniza tus centros de energía", config: { mode: "guided", level: "intermediate", audio: "meditation21", minutes: 20 } },
  { day: 17, title: "Silencio activo", focus: "Quietud profunda y despierta", config: { mode: "guided", level: "intermediate", audio: "meditation21", minutes: 20 } },
  { day: 18, title: "Compasión interior", focus: "Trátate con amabilidad genuina", config: { mode: "guided", level: "intermediate", audio: "meditation21", minutes: 20 } },
  { day: 19, title: "Presencia total", focus: "Cuerpo, mente y energía en unidad", config: { mode: "guided", level: "intermediate", audio: "meditation21", minutes: 20 } },
  { day: 20, title: "Sanación profunda", focus: "Permite que la energía sane", config: { mode: "guided", level: "intermediate", audio: "meditation21", minutes: 20 } },
  { day: 21, title: "Integración completa", focus: "Celebra tu evolución", config: { mode: "guided", level: "intermediate", audio: "meditation21", minutes: 20 } },
];
