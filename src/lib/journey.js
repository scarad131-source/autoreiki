...
export const JOURNEY = [
  ...
  { day: 2, title: "Escuchar el silencio", focus: "Atención a los sonidos sin juzgarlos", config: { mode: "unguided", level: "beginner", audio: "forest", minutes: 5 } },
  { day: 3, title: "Sentir el cuerpo", focus: "Recorrido suave por cada zona del cuerpo", config: { mode: "guided", level: "beginner", audio: "forest", minutes: 10 } },
  ...
  { day: 5, title: "Textura del presente", focus: "Toca y siente sin nombrar", config: { mode: "unguided", level: "beginner", audio: "beach", minutes: 5 } },
  { day: 6, title: "Gusto de la quietud", focus: "Saborea el instante con lentitud", config: { mode: "guided", level: "beginner", audio: "healing", minutes: 10 } },
  { day: 7, title: "Sentidos integrados", focus: "Los cinco sentidos en un solo instante", config: { mode: "guided", level: "beginner", audio: "forest", minutes: 10 } },
  ...
  { day: 9, title: "Respiración 4-7-8", focus: "Ritmo que calma y concentra", config: { mode: "unguided", level: "intermediate", audio: "healing", minutes: 10 } },
  ...
  { day: 11, title: "Contar sin juzgar", focus: "Cuenta respiraciones del 1 al 10", config: { mode: "unguided", level: "intermediate", audio: "beach", minutes: 10 } },
  { day: 12, title: "Observar el pensamiento", focus: "Mira los pensamientos pasar como nubes", config: { mode: "guided", level: "intermediate", audio: "healing", minutes: 15 } },
  { day: 13, title: "Vacío y plenitud", focus: "Reposa en el espacio entre pensamientos", config: { mode: "unguided", level: "intermediate", audio: "forest", minutes: 15 } },
  { day: 14, title: "Concentración estable", focus: "Atención sostenida sin esfuerzo", config: { mode: "guided", level: "intermediate", audio: "healing", minutes: 15 } },
  // Fase 3 — Integración
  { day: 15, title: "Fluir sin esfuerzo", focus: "Deja que la práctica suceda", config: { mode: "guided", level: "intermediate", audio: "beach", minutes: 15 } },
  ...
  { day: 17, title: "Silencio activo", focus: "Quietud profunda y despierta", config: { mode: "unguided", level: "intermediate", audio: "forest", minutes: 15 } },
  { day: 18, title: "Compasión interior", focus: "Trátate con amabilidad genuina", config: { mode: "guided", level: "intermediate", audio: "healing", minutes: 15 } },
  { day: 19, title: "Presencia total", focus: "Cuerpo, mente y energía en unidad", config: { mode: "unguided", level: "intermediate", audio: "beach", minutes: 20 } },
