      ...
      {CARDS.map((card) => {
        ...
        return (
          <button
            ...
            className="relative flex flex-col items-center justify-end gap-2 rounded-2xl border border-white/10 bg-card/40 backdrop-blur-sm overflow-hidden aspect-square hover:border-primary/40 transition-all active:scale-[0.97] hidden">
            {card.image ?
            <>
                <Image
                src={card.image}
