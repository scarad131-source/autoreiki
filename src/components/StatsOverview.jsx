...
export default function StatsOverview({ sessions }) {
  ...
  const stats = [
    { label: "Sesiones", value: sessions.length, icon: Sparkles, color: "text-violet-600" },
    { label: "Minutos", value: totalMinutes, icon: Clock, color: "text-teal-600" },
    { label: "Racha", value: `${streak}d`, icon: Flame, color: "text-amber-600" },
  ];
